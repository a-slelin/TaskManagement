...
public class ControllerLogging {
    ...
    @Around("execution(* a.slelin.work.task.management.auth.controller.rest..*.*(..))")
    ...
    @Around("execution(* a.slelin.work.task.management.auth.controller..*.*(..)) && " +
            "!execution(* a.slelin.work.task.management.auth.controller.rest..*.*(..)) && " +
